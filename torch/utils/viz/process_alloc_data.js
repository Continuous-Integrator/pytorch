...
function process_alloc_data(snapshot, device, plot_segments, max_entries, include_private_inactive = false) {
  ...
  // --- Phase 2: Add blocks from the segment snapshot ---
  // Blocks that exist in the current segment state but weren't seen in the
  // trace (allocated before recording, never freed).
