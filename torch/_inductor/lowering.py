...
def philox_rand(size, seed, offset, stride, device, dtype):
    # stride arg is used to ensure RNG spatial alignment with non-contiguous
    # layouts (e.g., transposed or sliced views). When None, fall back to
    # contiguous strides for backward compatibility.
    if stride is None:
