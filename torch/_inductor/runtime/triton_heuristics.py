...
class CachingAutotuner(KernelInterface):
    ...
    def __init__(
        ...
        self._force_fast_path = torch._inductor.config.force_fast_triton_launcher_path
    ...
    def run(
        ...
        **kwargs,
        ...
        if (
            ...
            and not kwargs
            and (
                self._force_fast_path
                or (
                    not autograd_profiler._is_profiler_enabled
        ...
        if (
            ...
            and (
                self._force_fast_path
                or (not debug_mode and not autograd_profiler._is_profiler_enabled)
            )
