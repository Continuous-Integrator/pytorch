    ...
    def failed(self, tx: InstructionTranslatorBase) -> bool:
        if self._failed:
            if self.error_on_graph_break is None:
                raise AssertionError("expected self.error_on_graph_break is not None to be true")
...
def _detect_and_normalize_assert_statement(
    ...
    if not isinstance(self.instruction_pointer, int):
        raise AssertionError("expected isinstance(self.instruction_pointer, int) to be true")
...
def generic_jump(
    ...
    def jump_graph_break(
        ...
        if not self.should_compile_partial_graph():
            raise AssertionError("expected self.should_compile_partial_graph() to be true")
    ...
    for tx in reversed(all_txes):
        for b in tx.block_stack:
            ...
            if not isinstance(b.with_context, (ContextWrappingVariable)):
                raise AssertionError("expected isinstance(b.with_context, (ContextWrappingVariable)) to be true")
        ...
        def wrapper(self: InstructionTranslatorBase, inst: Instruction) -> None:
            ...
            if speculation.failed(self):
                ...
                if speculation.reason is None:
                    raise AssertionError("expected speculation.reason is not None to be true")
...
class ExceptionStack:
    ...
    def move_current_exception_to_stack(self) -> None:
        if self._current_exception is None:
            raise AssertionError("expected self._current_exception is not None to be true")
...
class InstructionTranslatorBase(
    ...
    def maybe_has_backedge(self) -> bool:
        ...
        while cur_tx is not None:
            ...
            if cur_tx.instruction_pointer is None:
                raise AssertionError("expected cur_tx.instruction_pointer is not None to be true")
    ...
    def call_function(
        ...
        if not all(
            ...
            raise AssertionError("expected all( isinstance(x, VariableTracker) for x in itertools.chain(args, kwargs.values()) ) to be true")
        inner_fn = None
        if hasattr(fn, "value"):
            inner_fn = fn.value
        if hasattr(fn, "fn"):
            ...
            if entry:
                ...
                if self.block_stack and inst.opname not in (
                    ...
                    if len(self.block_stack) != 1:
                        raise AssertionError("expected len(self.block_stack) == 1 to be true")
                    self.block_stack.pop()
    ...
    def next_instruction(self) -> Instruction:
        if self.instruction_pointer is None:
            raise AssertionError("expected self.instruction_pointer is not None to be true")
    ...
    def step_graph_break(self, continue_inst: Instruction) -> None:
        ...
        if self.output.output_instructions:
            raise AssertionError("expected not self.output.output_instructions to be true")
        if self.current_speculation is None:
            raise AssertionError("expected self.current_speculation is not None to be true")
    ...
    def LOAD_DEREF(self, inst: Instruction) -> None:
        if inst.argval not in self.cell_and_freevars():
            raise AssertionError("expected inst.argval in self.cell_and_freevars() to be true")
    ...
    def STORE_DEREF(self, inst: Instruction) -> None:  # type: ignore[override]
        ...
        if not isinstance(cell, CellVariable):
            raise AssertionError("expected isinstance(cell, CellVariable) to be true")  # tame mypy
    ...
    def import_source(self, module_name: str) -> GlobalSource:
        ...
        if not (alias not in f_globals or f_globals[alias] is value):
            raise AssertionError("expected alias not in f_globals or f_globals[alias] is value to be true")
    ...
    def _attach_traceback_to_exception(self, exc: ExceptionVals) -> None:
        ...
        if not isinstance(
            ...
            raise AssertionError("expected isinstance( tb, (ConstantVariable, TracebackVariable) ) to be true")  # make pyrefly happy
    ...
    def CLEANUP_THROW(self, inst: Instruction) -> None:
        ...
        if not isinstance(tos, ExceptionVariable):
            raise AssertionError("expected isinstance(tos, ExceptionVariable) to be true")
    ...
    def exception_handler(self, raised_exception: ObservedException) -> None:
        ...
        def bubble_exception_to_interpreter() -> None:
            ...
            if not isinstance(raised_exception, dynamo_exc):
                raise AssertionError("expected isinstance(raised_exception, dynamo_exc) to be true")  # sanity check
            unimplemented(
    ...
    def CALL_FUNCTION_EX(self, inst: Instruction) -> None:
        ...
        if sys.version_info >= (3, 13):
            ...
            if not isinstance(null, NullVariable):
                raise AssertionError("expected isinstance(null, NullVariable) to be true")
    ...
    def CALL_FUNCTION_KW(self, inst: Instruction) -> None:
        ...
        if not isinstance(argnames, TupleVariable):
            raise AssertionError("expected isinstance(argnames, TupleVariable) to be true")
    ...
    def create_resume(
        ...
        if self.current_instruction.offset is None:
            raise AssertionError("expected self.current_instruction.offset is not None to be true")
    ...
    def BUILD_MAP_UNPACK(self, inst: Instruction) -> None:
        ...
        for x in items:
            if not isinstance(x, ConstDictVariable):
                raise AssertionError("expected isinstance(x, ConstDictVariable) to be true")
    ...
    def MAP_ADD(self, inst: Instruction) -> None:
        ...
        if not isinstance(obj, ConstDictVariable):
            raise AssertionError("expected isinstance(obj, ConstDictVariable) to be true")
    ...
    def MAKE_FUNCTION(self, inst: Instruction) -> None:
        ...
        if sys.version_info >= (3, 11):
            ...
            if not hasattr(code.value, "co_qualname"):
                raise AssertionError("expected hasattr(code.value, \"co_qualname\") to be true")  # type: ignore[attr-defined]
        ...
        if annotations:
            if not isinstance(annotations, TupleVariable):
                raise AssertionError("expected isinstance(annotations, TupleVariable) to be true")
    ...
    def IS_OP(self, inst: Instruction) -> None:
        if not (inst.argval == 0 or inst.argval == 1):
            raise AssertionError("expected inst.argval == 0 or inst.argval == 1 to be true")
        if inst.argval == 0:
            new_argval = "is"
        else:
            new_argval = "is not"
    ...
    def _call(self, inst: Instruction, call_kw: bool = False) -> None:
        ...
        if call_kw:
            ...
            if not isinstance(kw_names, TupleVariable):
                raise AssertionError("expected isinstance(kw_names, TupleVariable) to be true")
            if not kw_names.is_python_constant():
                raise AssertionError("expected kw_names.is_python_constant() to be true")
        ...
        if sys.version_info >= (3, 11):
            ...
            if inst.exn_tab_entry and (
                ...
                if self.next_instruction.exn_tab_entry is None:
                    raise AssertionError("expected self.next_instruction.exn_tab_entry is not None to be true")
    ...
    def setup_or_before_with(self, inst: Instruction) -> None:
        ...
        if not isinstance(
            ...
            raise AssertionError("expected isinstance( ctx, (ContextWrappingVariable, GenericContextWrappingVariable) ) to be true")
    ...
    def MAKE_CELL(self, inst: Instruction) -> None:
        if sys.version_info >= (3, 12) and not self.accept_prefix_inst:
            ...
            if not isinstance(self.symbolic_locals[inst.argval], NullVariable):
                raise AssertionError("expected isinstance(self.symbolic_locals[inst.argval], NullVariable) to be true")
    ...
    def CALL_INTRINSIC_2(self, inst: Instruction) -> None:
        ...
        if inst.argval == 4:
            ...
            if not isinstance(arg1, BaseUserFunctionVariable):
                raise AssertionError("expected isinstance(arg1, BaseUserFunctionVariable) to be true")
            arg1.call_method(
                self,  # pyrefly: ignore[bad-argument-type]
                "__setattr__",
    ...
    def TO_BOOL(self, inst: Instruction) -> None:
        ...
        if self.next_instruction.opname not in (
            ...
            raise AssertionError("expected self.next_instruction.opname in ( \"POP_JUMP_IF_TRUE\", \"POP_JUMP_IF_FALSE\", \"UNARY_NOT\", ) to be true")
    ...
    def SET_FUNCTION_ATTRIBUTE(self, inst: Instruction) -> None:
        ...
        if not isinstance(fn, NestedUserFunctionVariable):
            raise AssertionError("expected isinstance(fn, NestedUserFunctionVariable) to be true")
        attr = self.pop()
        ...
        if flags & 0x10:
            ...
            if not isinstance(attr, TupleVariable):
                raise AssertionError("expected isinstance(attr, TupleVariable) to be true")
            # Convert the attribute to a dictionary before assigning it
            # https://github.com/python/cpython/blob/28fb13cb33d569720938258db68956b5f9c9eb40/Objects/funcobject.c#L574-L594
            items = attr.items
            ann = ConstDictVariable(
...
class InstructionTranslator(InstructionTranslatorBase):
        ...
        with tracing(self.output.tracing_context), self.set_current_tx():
            ...
            if self.export:
                if not self.one_graph:
                    raise AssertionError("Export without one graph - something has gone wrong.")
    ...
    def _return(self, inst: Instruction) -> None:
        ...
        if len(all_stack_locals_metadata) != 1:
            raise AssertionError("expected len(all_stack_locals_metadata) == 1 to be true")
        if all_stack_locals_metadata[0].stack_null_idxes:
            raise AssertionError("expected not all_stack_locals_metadata[0].stack_null_idxes to be true")
        self.output.add_output_instructions(
...
class InliningInstructionTranslator(InstructionTranslatorBase):
    ...
    def build_inline_tracer(
        ...
        if not isinstance(
            ...
            raise AssertionError("expected isinstance( func, ( UserFunctionVariable, NestedUserFunctionVariable, LocalGeneratorFunctionVariable, ), ) to be true")
        ...
        if isinstance(func, SkipFunctionVariable):
            raise AssertionError("expected not isinstance(func, SkipFunctionVariable) to be true")
        ...
        if config.enable_faithful_generator_behavior or (
            ...
            if (
                ...
                if not isinstance(self, InliningGeneratorInstructionTranslator):
                    raise AssertionError("expected isinstance(self, InliningGeneratorInstructionTranslator) to be true")
            ...
            if is_generator(code):
                if not isinstance(self, InliningGeneratorInstructionTranslator):
                    raise AssertionError("expected isinstance(self, InliningGeneratorInstructionTranslator) to be true")
                if not self.symbolic_result.is_constant_none():
                    raise AssertionError("expected self.symbolic_result.is_constant_none() to be true")
